...
const jsPath = '/tmp/restore-final/assets/index-8n3ZwdDs.js';
...
const arrayEndIndex = i;
const arrayContent = jsContent.substring(startIndex, arrayEndIndex + 1);
const originalSlugCount = (arrayContent.match(/slug:/g) || []).length;
console.log('Original slug count:', originalSlugCount);
...
const newPosts = [
  {
    ...
    content: `
      <p class="lead">Creating a digital time capsule is one of the most meaningful things you can do. It is a way to capture your current life and send it forward to your future self.</p>
  ...
  },
  {
    ...
    content: `
      <p class="lead">Looking for romantic time capsule ideas? You have come to the right place. Time capsules are one of the most romantic gifts you can give.</p>
      <h2>Why Time Capsules Are Romantic</h2>
      <p>Anyone can buy flowers. But a time capsule? That is personal. That is thoughtful. That says I love you not just for today, but for all the tomorrows.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li>Details from the day you will forget</li>
  ...
  },
  {
    ...
    content: `
      <p class="lead">What if you could hide a secret message inside a photo? That is steganography - and it is easier than you think.</p>
      ...
      <h2>How It Works</h2>
      <p>Digital photos are made of pixels. Each pixel has red, green, and blue values. We can hide data in the smallest bits of these values - your eye cannot see the difference.</p>
      <h2>Is It Secure?</h2>
  ...
  },
  {
    ...
    content: `
      ...
      <p>They give you both something to look forward to. They create shared moments even when you are apart. They turn waiting into anticipation.</p>
  ...
  },
  {
    ...
    content: `
      <p class="lead">We are often kinder to others than we are to ourselves. A self-love time capsule is a gift from you today to you tomorrow.</p>
  ...
  },
  {
    ...
    subtitle: "Create a pet memorial time capsule to honor your beloved pet. Seal memories and photos that you can revisit when you are ready.",
  ...
  },
  {
    ...
    content: `
      <p class="lead">Another piece of jewelry? Another bottle of wine? Boring. The best anniversary gifts are not things - they are feelings, memories, and meaning.</p>
  ...
  },
  {
    ...
    content: `
      <p class="lead">What if a time capsule required both of you to unlock it? That is Couple Mode - two hearts, one lock.</p>
  ...
  },
  {
    ...
    subtitle: "Cannot go out? These at-home date ideas are fun, romantic, and way more interesting than another night on the couch.",
    category: "Date Night",
    categoryColor: "#f472b6",
    readTime: "7 min read",
    date: "June 24, 2026",
  ...
  },
  {
    ...
    content: `
      <p class="lead">Long distance relationships are challenging. But distance doesn't have to mean less romance. These long distance date ideas help you stay connected and create shared memories even when you're miles apart.</p>
      <h2>15 Long Distance Date Ideas</h2>
      <ol>
        <li>Watch the same movie together over video call</li>
        <li>Cook the same recipe together on video</li>
        <li>Create matching time capsules to open on the same date</li>
        <li>Virtual game night</li>
        <li>Read the same book and discuss it</li>
        <li>Take a virtual class together</li>
        <li>Write each other old-fashioned letters</li>
        <li>Plan your next visit together</li>
        <li>Virtual museum tour</li>
        <li>Make playlists for each other</li>
        <li>Online trivia night</li>
        <li>Stargaze together at the same time</li>
        <li>Create a shared bucket list</li>
        <li>Send surprise care packages</li>
        <li>Write time capsules for when you're reunited</li>
      </ol>
      <p>Our favorite? Matching time capsules. You both write a letter, seal it in a photo, set the same unlock date. It's like having a shared moment even when you're apart.</p>
      <p><a href="/#seal">Create matching long distance capsules →</a></p>
    `
  },
  {
    slug: "new-home-gift-time-capsule",
    title: "New Home Gift: A Time Capsule for Your New Chapter",
    subtitle: "Moving into a new home? Celebrate this new chapter with a time capsule that captures this exciting moment in your life.",
    category: "Milestones",
    categoryColor: "#a78bfa",
    readTime: "5 min read",
    date: "June 24, 2026",
    tags: ["new home", "housewarming", "new chapter", "home gift"],
    content: `
      <p class="lead">Moving into a new home is a big milestone. It's the start of a new chapter. A time capsule helps you remember exactly what this moment felt like.</p>
      <h2>What to Include in a New Home Time Capsule</h2>
      <ul>
        <li>Photo of you in your new home</li>
        <li>Why you chose this house/apartment</li>
        <li>Your hopes for life here</li>
        <li>What the neighborhood is like right now</li>
        <li>Your favorite room and why</li>
        <li>Dreams for the future in this home</li>
        <li>Current rent or mortgage payment (fun to look back at!)</li>
      </ul>
      <h2>When to Open It</h2>
      <p>5 years from now, or when you move out. Imagine looking back and remembering how excited you were on move-in day.</p>
      <p><a href="/#seal">Create a new home time capsule →</a></p>
    `
  },
  {
    slug: "time-capsule-wedding-ceremony",
    title: "Time Capsule Wedding Ceremony: A Modern Unity Ritual",
    subtitle: "Forget unity candles and sand ceremonies. A time capsule wedding ceremony is a meaningful ritual you'll revisit for years.",
    category: "Weddings",
    categoryColor: "#a78bfa",
    readTime: "6 min read",
    date: "June 24, 2026",
  ...
  {
    slug: "baby-shower-time-capsule",
    title: "Baby Shower Time Capsule: A Gift for the New Baby",
    subtitle: "Looking for a unique baby shower gift? A time capsule is something the child will treasure when they're older.",
    category: "Family",
    categoryColor: "#fbbf24",
    readTime: "5 min read",
    date: "June 24, 2026",
    tags: ["baby shower", "new baby", "baby gift", "family"],
    content: `
      <p class="lead">Baby showers are full of cute outfits and tiny socks. But a time capsule? That's a gift they'll still have when they're 18.</p>
      <h2>What to Include in a Baby Time Capsule</h2>
      <ul>
        <li>Letter to the baby from you</li>
        <li>Your wishes for their life</li>
        <li>What the world is like right now</li>
        <li>Advice for when they're older</li>
        <li>Your favorite memory of their parents</li>
        <li>Photo of you and the parents</li>
      </ul>
      <h2>When Should They Open It?</h2>
      <p>Their 18th birthday, high school graduation, or when they have their first baby. Imagine a teenager reading letters from all the people who loved them before they were even born - it's priceless.</p>
      <p><a href="/#seal">Create a baby shower time capsule →</a></p>
    `
  }
];
...
function formatPost(post) {
  ...
  const escapedSubtitle = post.subtitle.replace(/\\/g, '\\\\').replace(/'/g, "\\'");
  const escapedContent = post.content.replace(/\\/g, '\\\\').replace(/`/g, '\\`').replace(/\$\{/g, '\\${');
  const escapedTags = post.tags.map(t => t.replace(/\\/g, '\\\\').replace(/"/g, '\\"')).map(t => `"${t}"`).join(',');
  
  return `{slug:"${post.slug}",title:"${escapedTitle}",subtitle:'${escapedSubtitle}',category:"${post.category}",categoryColor:"${post.categoryColor}",readTime:"${post.readTime}",date:"${post.date}",tags:[${escapedTags}],content:\`${escapedContent}\`}`;
}

const newPostsStr = newPosts.map(formatPost).join(',');

const beforeArray = jsContent.substring(0, arrayEndIndex);
const afterArray = jsContent.substring(arrayEndIndex);

const modifiedContent = beforeArray.slice(0, -1) + ',' + newPostsStr + ']' + afterArray.slice(1);

const newJsPath = '/tmp/restore-final/assets/index-8n3ZwdDs.js';
fs.writeFileSync(newJsPath, modifiedContent);

const newArrayContent = modifiedContent.substring(startIndex, startIndex + (arrayEndIndex - startIndex) + 1000);
const newSlugCount = (newArrayContent.match(/slug:/g) || []).length;

console.log('Done! New file size:', (modifiedContent.length / 1024).toFixed(0), 'KB');
console.log('Original posts:', originalSlugCount);
console.log('New posts added:', newPosts.length);
console.log('Total posts:', originalSlugCount + newPosts.length);
